package com.example.tbag.weathercheck.bluetooth;
...
import com.example.tbag.weathercheck.exception.CannotOpenSocketException;
import com.example.tbag.weathercheck.exception.NoDeviceFoundExpcetion;
import com.example.tbag.weathercheck.exception.NoEnsurePairedException;
	...
	private void scan(){
		...
		localDevice.scan(new ScanListener(){
			...
			public void deviceFound(RemoteDevice arg0) {
				// TODO Auto-generated method stub
				String name=arg0.getFriendlyName();
				String adr = arg0.getAddress();
				BTService.this.devices.put(adr, arg0);
				
				Intent intent=new Intent();
				intent.putExtra("name", name);
				intent.putExtra("address",arg0.getAddress());
